...
var UserSchema = new mongoose.Schema({
    ...
    userType: {
        ...
        validate: {
            validator: (value) =>{
                return validator.matches(value,'(?:Customer|Owner|Staff)');
            },
            message: 'The userType must be Customer,Owner or Staff!'
        } 
    },
    addedAt: {
        type: Number,
...
UserSchema.methods.toJSON = function() {
    ...
    return _.pick(userObject,['_id','email','firstName','lastName','userType','businesses','queues']);
};
